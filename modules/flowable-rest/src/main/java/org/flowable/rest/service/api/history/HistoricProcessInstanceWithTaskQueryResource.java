...
public class HistoricProcessInstanceWithTaskQueryResource extends HistoricProcessInstanceBaseResource {
    ...
    @PostMapping(value = "/query/historic-process-instances-with-task", produces = "application/json")
    public DataResponse<HistoricProcessInstanceResponse> queryProcessInstances(@RequestBody HistoricProcessInstanceWithTaskQueryRequest queryRequest, @ApiParam(hidden = true) @RequestParam Map<String, String> allRequestParams, HttpServletRequest request) {
