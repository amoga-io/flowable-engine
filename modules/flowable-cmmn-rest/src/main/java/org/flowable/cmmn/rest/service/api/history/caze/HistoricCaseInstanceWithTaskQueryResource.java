...
public class HistoricCaseInstanceWithTaskQueryResource extends HistoricCaseInstanceBaseResource {
    ...
    @PostMapping(value = "/cmmn-query/historic-case-instances-with-task", produces = "application/json")
    public DataResponse<HistoricCaseInstanceResponse> queryCasesInstances(@RequestBody HistoricCaseInstanceWithTaskQueryRequest queryRequest, @ApiParam(hidden = true) @RequestParam Map<String, String> allRequestParams, HttpServletRequest request) {
